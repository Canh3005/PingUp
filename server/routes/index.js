...
import devlogRoutes from './devlogRoutes.js';
import hubActivityRoutes from './hubActivityRoutes.js';
...
router.use('/devlogs', devlogRoutes);
router.use('/hub-activities', hubActivityRoutes);
