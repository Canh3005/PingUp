...
const ACTIVITY_TYPES = {
  ...
  RECRUITMENT_CREATED: 'recruitment_created',
  RECRUITMENT_UPDATED: 'recruitment_updated',
  RECRUITMENT_CLOSED: 'recruitment_closed',
  RECRUITMENT_FILLED: 'recruitment_filled',
...
const ACTIVITY_CATEGORIES = {
  ...
  RECRUITMENT: [
    ACTIVITY_TYPES.RECRUITMENT_CREATED,
    ACTIVITY_TYPES.RECRUITMENT_UPDATED,
    ACTIVITY_TYPES.RECRUITMENT_CLOSED,
    ACTIVITY_TYPES.RECRUITMENT_FILLED,
    ACTIVITY_TYPES.APPLICATION_CREATED,
    ACTIVITY_TYPES.APPLICATION_REVIEWED,
  ],
  FILE: [
