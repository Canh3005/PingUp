      ...
      <div className="space-y-3">
        {displayFollowers.map((follower) => (
          <div
            ...
            onClick={() => handleViewProfile(follower.userId)}
          >
            <img
              src={follower.avatarUrl || 'https://via.placeholder.com/36'}
              alt={follower.name}
            ...
            <div className="flex-1 min-w-0">
              ...
              {follower.jobTitle && (
                <p className="text-xs text-gray-500 truncate">{follower.jobTitle}</p>
              )}
            </div>
          </div>
        ))}
